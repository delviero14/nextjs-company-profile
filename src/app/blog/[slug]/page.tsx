    ...
    return (
        <Wrapper>
            <div className="pb-[120px] ">
                <div className="pl-3 flex-1 sticky max-lg:hidden max-md:hidden top-[100px] h-full">
                ...
                <div className="-mx-4 flex flex-wrap justify-center">
                    ...
                    <h5 className="mb-8 text-3xl font-bold leading-tight text-black dark:text-white sm:text-4xl sm:leading-tight">{blog.fields.title}</h5>
                    ...
                    <img className="mb-10 w-full overflow-hidden rounded relative aspect-[97/60] sm:aspect-[97/44] " src={`https:${blog.fields.image.fields.file.url}`} alt={blog.fields.title} />
